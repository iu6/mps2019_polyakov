...
int main(void)
{
	...
	ADC_InitStructure.ADC_TempSensor = ADC_TEMP_SENSOR_Enable;       // Turn off 
	ADC_InitStructure.ADC_TempSensorAmplifier = ADC_TEMP_SENSOR_AMPLIFIER_Enable; // Turn off the amplifier of the temperature sensor
  ADC_InitStructure.ADC_TempSensorConversion = ADC_TEMP_SENSOR_CONVERSION_Enable;  // Turn off temperature sensor conversion
	ADC_InitStructure.ADC_IntVRefConversion = ADC_VREF_CONVERSION_Enable;  // Turn off preobrazovaniye opornogo napr
